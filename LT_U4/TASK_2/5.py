...
range_amount = df['Order_Amount'].max() - df['Order_Amount'].min()
variance_amount = df['Order_Amount'].var()
std_dev_amount = df['Order_Amount'].std()

print(f"Range: {range_amount}")
print(f"Variance: {variance_amount}")
print(f"Standard Deviation: {std_dev_amount}")