...
print("\n Salary > 60000 AND Experience > 5 years:\n",
      employee[(employee['Salary'] > 60000) & (employee['Experience_Years'] > 5)])

print("\n Salary < 60000 OR Experience < 4 years:\n",
      employee[(employee['Salary'] < 60000) | (employee['Experience_Years'] < 4)])

print("\n Employees NOT in Finance department:\n",
      employee[employee['Department_ID'] != 2])