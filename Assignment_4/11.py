...
# [cite_start]11. Use .interpolate() to fill missing Age values [cite: 177]
print("\n--- 11. Interpolate Missing Age Values ---")
df_interpolated = df.copy()
df_interpolated['Age'] = df_interpolated['Age'].interpolate()
print("Original and interpolated 'Age' for comparison:")
print(df[['Name', 'Age']].join(df_interpolated[['Age']].rename(columns={'Age': 'Age_Interpolated'})))