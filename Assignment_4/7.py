...
# [cite_start]7. Detect outliers in the Salary column using the IQR method [cite: 173]
print("\n--- 7. Outlier Detection in Salary ---")
...
if outliers.empty:
    print(f"No outliers found in the Salary column (Bounds: {lower_bound}, {upper_bound}).")
else:
    print("Outliers found in Salary column:\n", outliers)