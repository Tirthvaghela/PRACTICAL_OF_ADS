...
# [cite_start]18. Fill missing values with string "Unknown" [cite: 184]
print('\n--- 18. Fill Missing Values with "Unknown" ---')
df_unknown = df.copy()
df_unknown.fillna("Unknown", inplace=True)
# Displaying only rows with original NaNs to see the change
print(df_unknown.loc[[2, 4, 11]])
