...
# ================================================
print("\n Age > 30 AND Salary > 65000 AND Experience < 10:\n",
      employee[(employee['Age'] > 30) & (employee['Salary'] > 65000) & (employee['Experience_Years'] < 10)])

print("\n Department_ID in [1,3] AND Salary < 75000:\n",
      employee[((employee['Department_ID'] == 1) | (employee['Department_ID'] == 3)) & (employee['Salary'] < 75000)])
